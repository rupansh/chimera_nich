...
static const struct ieee80211_regdomain regdom_AL = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5250, 5350, 80, 0, 23, 0, 
			NL80211_RRF_DFS | 
			NL80211_RRF_AUTO_BW | 0),
		REG_RULE_EXT(5470, 5710, 160, 0, 30, 0, 
			NL80211_RRF_DFS | 0),
	},
	.n_reg_rules = 4
};
...
static const struct ieee80211_regdomain regdom_AR = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5170, 5250, 80, 0, 23, 0, 
			NL80211_RRF_AUTO_BW | 0),
		REG_RULE_EXT(5250, 5330, 80, 0, 36, 0, 
			NL80211_RRF_AUTO_BW | 0),
		REG_RULE_EXT(5490, 5590, 80, 0, 36, 0, 0),
		REG_RULE_EXT(5650, 5730, 80, 0, 36, 0, 0),
...
static const struct ieee80211_regdomain regdom_AS = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5730, 160, 0, 24, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5735, 5850, 80, 0, 30, 0, 0),
	},
	.n_reg_rules = 5
};
...
static const struct ieee80211_regdomain regdom_AT = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5710, 160, 0, 30, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5850, 5870, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5860, 5880, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5870, 5890, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5880, 5900, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5890, 5910, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5900, 5920, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5910, 5930, 10, 0, 30, 0, 0),
		REG_RULE_EXT(57240, 65880, 2160, 0, 40, 0, 
...
static const struct ieee80211_regdomain regdom_BH = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5330, 20, 0, 23, 0, 0),
		REG_RULE_EXT(5735, 5835, 20, 0, 33, 0, 0),
	},
	.n_reg_rules = 3
};
...
static const struct ieee80211_regdomain regdom_BZ = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5330, 160, 0, 23, 0, 0),
		REG_RULE_EXT(5490, 5730, 160, 0, 30, 0, 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 0),
	},
	.n_reg_rules = 4
};
...
static const struct ieee80211_regdomain regdom_CF = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5250, 40, 0, 24, 0, 0),
...
static const struct ieee80211_regdomain regdom_CL = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5330, 160, 0, 20, 0, 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 20, 0, 0),
	},
	.n_reg_rules = 3
};
...
static const struct ieee80211_regdomain regdom_CN = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5250, 5330, 80, 0, 23, 0, 
			NL80211_RRF_DFS | 
			NL80211_RRF_AUTO_BW | 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 33, 0, 0),
...
static const struct ieee80211_regdomain regdom_CR = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5250, 20, 0, 24, 0, 0),
...
static const struct ieee80211_regdomain regdom_HN = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5330, 160, 0, 24, 0, 0),
		REG_RULE_EXT(5490, 5730, 160, 0, 24, 0, 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 0),
	},
	.n_reg_rules = 4
};
...
static const struct ieee80211_regdomain regdom_JP = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5710, 160, 0, 20, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(59000, 66000, 2160, 0, 10, 0, 0),
	},
	.n_reg_rules = 5
};
...
static const struct ieee80211_regdomain regdom_PA = {
	.alpha2 = "PA",
	.reg_rules = {
		REG_RULE_EXT(2402, 2472, 40, 0, 36, 0, 0),
		REG_RULE_EXT(5170, 5250, 80, 0, 23, 0, 0),
		REG_RULE_EXT(5250, 5330, 80, 0, 30, 0, 
			NL80211_RRF_AUTO_BW | 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 36, 0, 0),
...
static const struct ieee80211_regdomain regdom_RU = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5730, 160, 0, 30, 0, 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 0),
		REG_RULE_EXT(57240, 65880, 2160, 0, 40, 0, 0),
	},
	.n_reg_rules = 5
};
...
static const struct ieee80211_regdomain regdom_SV = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5250, 20, 0, 23, 0, 0),
...
static const struct ieee80211_regdomain regdom_TG = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5250, 5330, 40, 0, 23, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5490, 5710, 40, 0, 30, 0, 
			NL80211_RRF_DFS | 0),
	},
	.n_reg_rules = 4
};
...
static const struct ieee80211_regdomain regdom_TT = {
	...
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
		REG_RULE_EXT(5170, 5250, 80, 0, 24, 0, 0),
		REG_RULE_EXT(5250, 5330, 80, 0, 24, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5490, 5730, 160, 0, 24, 0, 
			NL80211_RRF_DFS | 0),
...
static const struct ieee80211_regdomain regdom_US = {
	...
	.reg_rules = {
		...
		REG_RULE_EXT(5490, 5730, 160, 0, 24, 0, 
			NL80211_RRF_DFS | 0),
		REG_RULE_EXT(5735, 5835, 80, 0, 30, 0, 0),
		REG_RULE_EXT(5842, 5863, 5, 0, 30, 0, 0),
		REG_RULE_EXT(5850, 5870, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5860, 5880, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5865, 5885, 20, 0, 30, 0, 0),
		REG_RULE_EXT(5870, 5890, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5880, 5900, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5890, 5910, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5895, 5915, 20, 0, 30, 0, 0),
		REG_RULE_EXT(5900, 5920, 10, 0, 30, 0, 0),
		REG_RULE_EXT(5910, 5930, 10, 0, 30, 0, 0),
...
static const struct ieee80211_regdomain regdom_XA = {
	.alpha2 = "XA",
	.dfs_region = NL80211_DFS_JP,
	.reg_rules = {
		REG_RULE_EXT(2402, 2482, 40, 0, 20, 0, 0),
